...
public class GameUIBar extends JPanel {
	...
	Image bgImage, lftBtn, rghtBtn, writeBG, exitBtn, backBtn, endTurnBtn, txtBack, chargeIcon; {
		try { 
	...
	public void paintComponent(Graphics g) {
		...
		if (selection == null) { //default menu
			...
			g2d.drawImage(imgArr[selection.getUnitImgIndex()], (int) Math.round(res*0.1),  (int) Math.round(res*0.1), (int) Math.round(res*1.75), (int) Math.round(res*1.75), null);
